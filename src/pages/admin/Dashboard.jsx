...
export default function AdminDashboard() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Greeting Banner */}
      <div className="bg-kala-dark rounded-3xl p-6 sm:p-8 text-white relative overflow-hidden">
      ...
      <div>
        <p className="text-sm font-semibold text-kala-dark mb-4">Quick Actions</p>
        <div className="grid grid-cols-4 gap-3 sm:gap-4">
          {QUICK_ACTIONS.map((a) => (
            <button
              key={a.label}
              onClick={() => navigate(a.path)}
              className="bg-white rounded-2xl sm:rounded-3xl p-3 sm:p-4 shadow-sm border border-kala-border flex flex-col items-center gap-3 hover:shadow-md hover:border-gray-300 transition-all active:scale-[0.99] text-center"
            >
      ...
      <div>
        ...
        <div className="flex flex-col gap-3 sm:gap-4">
          {loading ? (
            ...
            <div className="bg-white rounded-3xl p-8 text-center border border-kala-border shadow-sm">
