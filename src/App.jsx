...
export default function App() {
  return (
    <Routes>
      ...
      <Route element={
        <ProtectedRoute allowedRoles={['admin', 'employee', 'rsp_technician', 'rsp_issue', 'client']}>
          <AppLayout />
        </ProtectedRoute>
      }>
        {/* Admin */}
        ...
        {/* RSP Technician */}
        <Route path="/rsp" element={
          <ProtectedRoute allowedRoles={['rsp_technician']}><RspDashboard /></ProtectedRoute>
        } />

        {/* RSP Issue */}
        <Route path="/rsp-issue" element={
          <ProtectedRoute allowedRoles={['rsp_issue']}><RspIssueDashboard /></ProtectedRoute>
        } />
